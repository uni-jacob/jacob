...
Далее откроется меню Призыва. Здесь можно выбрать студентов для призыва (все студенты находятся в подменю по первым буквам их фамилий), выбрать всех студентов для Призыва, сохранить или отменить Призыв, изменить текст призыва  
